<template>
  <div class="w-100">
    <v-app-bar
      ...
      :height="screen_width> 959 ? headerHeight : mobileHeight"
      ...
      <div class="d-flex flex-column w-100 h-100">
        ...
        <v-container class="d-flex align-stretch py-0 flex-grow-1">
          ...
          <div class="ml-auto flex-grow-1 justify-center d-md-flex d-none flex-column">
            <div class="d-flex mx-n3 pt-5 mb-2" v-if="menuTopLinks.length">
              <a class="d-inline-block px-3 text-body-2 text-grey-lighten-1 text-decoration-none" v-for="menu_top_link in menuTopLinks" :href="menu_top_link.url" :key="menu_top_link">
                {{ menu_top_link.title }}
              </a>
            </div>
              ...
              <ul class="header-menu flex-grow-1">
                <li v-for="menu_item in menu" :key="`header-menu-item-${menu_item.id}`">
                  <NuxtLink
                    ...
                    :class="{'align-start' : menuTopLinks.length} "
